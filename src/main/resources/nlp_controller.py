...
def processar_pergunta(pergunta_usuario):
    ...
    def extrair_entidade(texto, chaves_ordenadas, mapa, nome_conceito, ph_map):
        for chave in chaves_ordenadas:
            # Usa \b (word boundary) para garantir que estamos pegando a palavra/frase inteira.
            # Ex: encontra "vale" mas não "equivalente".
            if re.search(r'\b' + re.escape(chave) + r'\b', texto):
                ...
                return True # Retorna True se encontrou para parar a busca por este tipo de entidade
        return False
    ...
    # Busca por "ação/ações" separadamente para o Template 3A
